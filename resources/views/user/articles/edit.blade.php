            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3" 
                              ...
                              placeholder="Brief description of your article" required>{{ old('excerpt', $article->excerpt) }}</textarea>
                    @error('excerpt')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    @if($article->image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $article->image) }}" alt="Current image" class="w-32 h-32 object-cover rounded-lg">
